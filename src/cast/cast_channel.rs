...
pub struct CastMessage {
    ...
    pub protocol_version: Option<protobuf::EnumOrUnknown<cast_message::ProtocolVersion>>,
    ...
    pub payload_type: Option<protobuf::EnumOrUnknown<cast_message::PayloadType>>,
...
impl CastMessage {
    ...
    pub fn set_protocol_version(&mut self, v: cast_message::ProtocolVersion) {
        self.protocol_version = Some(protobuf::EnumOrUnknown::new(v));
    }
    ...
    // Param is passed by value, moved
    pub fn set_source_id(&mut self, v: String) {
        self.source_id = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_source_id(&mut self) -> &mut String {
        if self.source_id.is_none() {
            self.source_id = Some(String::new());
        }
        self.source_id.as_mut().unwrap()
    }

    // Take field
    pub fn take_source_id(&mut self) -> String {
        self.source_id.take().unwrap_or_else(|| String::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_destination_id(&mut self, v: String) {
        self.destination_id = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_destination_id(&mut self) -> &mut String {
        if self.destination_id.is_none() {
            self.destination_id = Some(String::new());
        }
        self.destination_id.as_mut().unwrap()
    }

    // Take field
    pub fn take_destination_id(&mut self) -> String {
        self.destination_id.take().unwrap_or_else(|| String::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_namespace(&mut self, v: String) {
        self.namespace = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_namespace(&mut self) -> &mut String {
    ...
    // Take field
    pub fn take_namespace(&mut self) -> String {
        self.namespace.take().unwrap_or_else(|| String::new())
    }
    ...
    pub fn set_payload_type(&mut self, v: cast_message::PayloadType) {
        self.payload_type = Some(protobuf::EnumOrUnknown::new(v));
    }
    ...
    // Param is passed by value, moved
    pub fn set_payload_utf8(&mut self, v: String) {
        self.payload_utf8 = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_payload_utf8(&mut self) -> &mut String {
        if self.payload_utf8.is_none() {
            self.payload_utf8 = Some(String::new());
        }
        self.payload_utf8.as_mut().unwrap()
    }

    // Take field
    pub fn take_payload_utf8(&mut self) -> String {
        self.payload_utf8.take().unwrap_or_else(|| String::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_payload_binary(&mut self, v: Vec<u8>) {
        self.payload_binary = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_payload_binary(&mut self) -> &mut Vec<u8> {
        if self.payload_binary.is_none() {
            self.payload_binary = Some(Vec::new());
        }
        self.payload_binary.as_mut().unwrap()
    }

    // Take field
    pub fn take_payload_binary(&mut self) -> Vec<u8> {
        self.payload_binary.take().unwrap_or_else(|| Vec::new())
    }
...
impl protobuf::Message for CastMessage {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.protocol_version = Some(is.read_enum_or_unknown()?);
                },
                18 => {
                    self.source_id = Some(is.read_string()?);
                },
                26 => {
                    self.destination_id = Some(is.read_string()?);
                },
                34 => {
                    self.namespace = Some(is.read_string()?);
                },
                40 => {
                    self.payload_type = Some(is.read_enum_or_unknown()?);
                },
                50 => {
                    self.payload_utf8 = Some(is.read_string()?);
                },
                58 => {
                    self.payload_binary = Some(is.read_bytes()?);
                },
                64 => {
                    self.continued = Some(is.read_bool()?);
                },
                72 => {
                    self.remaining_length = Some(is.read_uint32()?);
                },
                tag => {
...
pub mod cast_message {
    ...
    impl protobuf::Enum for ProtocolVersion {
        ...
        fn from_i32(value: i32) -> Option<ProtocolVersion> {
            match value {
                0 => Some(ProtocolVersion::CASTV2_1_0),
                1 => Some(ProtocolVersion::CASTV2_1_1),
                2 => Some(ProtocolVersion::CASTV2_1_2),
                3 => Some(ProtocolVersion::CASTV2_1_3),
                _ => None
            }
        }
    ...
    impl protobuf::Enum for PayloadType {
        ...
        fn from_i32(value: i32) -> Option<PayloadType> {
            match value {
                0 => Some(PayloadType::STRING),
                1 => Some(PayloadType::BINARY),
                _ => None
            }
        }
...
pub struct AuthChallenge {
    ...
    pub signature_algorithm: Option<protobuf::EnumOrUnknown<SignatureAlgorithm>>,
    ...
    pub hash_algorithm: Option<protobuf::EnumOrUnknown<HashAlgorithm>>,
    // special fields
    // @@protoc_insertion_point(special_field:cast.channel.AuthChallenge.special_fields)
    pub special_fields: protobuf::SpecialFields,
}

impl<'a> Default for &'a AuthChallenge {
...
impl AuthChallenge {
    ...
    pub fn set_signature_algorithm(&mut self, v: SignatureAlgorithm) {
        self.signature_algorithm = Some(protobuf::EnumOrUnknown::new(v));
    }
    ...
    // Param is passed by value, moved
    pub fn set_sender_nonce(&mut self, v: Vec<u8>) {
        self.sender_nonce = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_sender_nonce(&mut self) -> &mut Vec<u8> {
        if self.sender_nonce.is_none() {
            self.sender_nonce = Some(Vec::new());
        }
        self.sender_nonce.as_mut().unwrap()
    }

    // Take field
    pub fn take_sender_nonce(&mut self) -> Vec<u8> {
        self.sender_nonce.take().unwrap_or_else(|| Vec::new())
    }
    ...
    pub fn set_hash_algorithm(&mut self, v: HashAlgorithm) {
        self.hash_algorithm = Some(protobuf::EnumOrUnknown::new(v));
    }
}
...
impl protobuf::Message for AuthChallenge {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.signature_algorithm = Some(is.read_enum_or_unknown()?);
                },
                18 => {
                    self.sender_nonce = Some(is.read_bytes()?);
                },
                24 => {
                    self.hash_algorithm = Some(is.read_enum_or_unknown()?);
                },
                tag => {
                    protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
impl<'a> Default for &'a AuthResponse {
...
impl AuthResponse {
    ...
    pub fn take_signature(&mut self) -> Vec<u8> {
        self.signature.take().unwrap_or_else(|| Vec::new())
    }
    ...
    pub fn clear_client_auth_certificate(&mut self) {
        self.client_auth_certificate = None;
    }
    ...
    // Param is passed by value, moved
    pub fn set_client_auth_certificate(&mut self, v: Vec<u8>) {
        self.client_auth_certificate = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_client_auth_certificate(&mut self) -> &mut Vec<u8> {
        if self.client_auth_certificate.is_none() {
            self.client_auth_certificate = Some(Vec::new());
        }
        self.client_auth_certificate.as_mut().unwrap()
    }

    // Take field
    pub fn take_client_auth_certificate(&mut self) -> Vec<u8> {
        self.client_auth_certificate.take().unwrap_or_else(|| Vec::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_crl(&mut self, v: Vec<u8>) {
        self.crl = Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_crl(&mut self) -> &mut Vec<u8> {
        if self.crl.is_none() {
            self.crl = Some(Vec::new());
        }
        self.crl.as_mut().unwrap()
    }

    // Take field
    pub fn take_crl(&mut self) -> Vec<u8> {
        self.crl.take().unwrap_or_else(|| Vec::new())
    }
}
...
impl protobuf::Message for AuthResponse {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.signature = Some(is.read_bytes()?);
                },
                18 => {
                    self.client_auth_certificate = Some(is.read_bytes()?);
                },
                26 => {
...
pub struct AuthError {
    ...
    pub error_type: Option<protobuf::EnumOrUnknown<auth_error::ErrorType>>,
    // special fields
    // @@protoc_insertion_point(special_field:cast.channel.AuthError.special_fields)
    pub special_fields: protobuf::SpecialFields,
}

impl<'a> Default for &'a AuthError {
...
impl AuthError {
    ...
    pub fn set_error_type(&mut self, v: auth_error::ErrorType) {
        self.error_type = Some(protobuf::EnumOrUnknown::new(v));
    }
}
...
impl protobuf::Message for AuthError {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.error_type = Some(is.read_enum_or_unknown()?);
                },
                tag => {
                    protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
pub mod auth_error {
    ...
    impl protobuf::Enum for ErrorType {
        ...
        fn from_i32(value: i32) -> Option<ErrorType> {
            match value {
                0 => Some(ErrorType::INTERNAL_ERROR),
                1 => Some(ErrorType::NO_TLS),
                2 => Some(ErrorType::SIGNATURE_ALGORITHM_UNAVAILABLE),
                _ => None
            }
        }
...
impl<'a> Default for &'a DeviceAuthMessage {
...
impl protobuf::Enum for SignatureAlgorithm {
    ...
    fn from_i32(value: i32) -> Option<SignatureAlgorithm> {
        match value {
            0 => Some(SignatureAlgorithm::UNSPECIFIED),
            1 => Some(SignatureAlgorithm::RSASSA_PKCS1v15),
            2 => Some(SignatureAlgorithm::RSASSA_PSS),
            _ => None
        }
    }
...
impl protobuf::Enum for HashAlgorithm {
    ...
    fn from_i32(value: i32) -> Option<HashAlgorithm> {
        match value {
